package me.loving11ish.stormerantispamreloaded.files;
...
public class MessagesFileManager {
    ...
    private StormerAntiSpamReloaded plugin;
    private FileConfiguration dataConfig = null;
    private File configFile = null;

    Logger logger = StormerAntiSpamReloaded.getPlugin().getLogger();

    public void MessagesFileManager(StormerAntiSpamReloaded plugin){
        this.plugin = plugin;
    ...
    public void saveMessagesConfig() {
        ...
        try {
            ...
            logger.severe(ColorUtils.translateColorCodes("&6StormerAntiSpamReloaded: &4Could not save messages.yml"));
            logger.severe(ColorUtils.translateColorCodes("&6StormerAntiSpamReloaded: &4Check the below message for the reasons!"));
            e.printStackTrace();
        }
    }
